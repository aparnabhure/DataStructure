public class FindMaxKMaxSubarraySumLengthK {
    ...
    static long maxSubArraySum(int[] A, int n, int K){
        long ans = 0;
        for(int i=0; i<K; i++){
            ans += A[i];
        }
