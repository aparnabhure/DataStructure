...
public class FirstMissingPositiveInteger {
    ...
    static int firstMissingPositive(int[] A) {
        ...
        //Try to swap the values to the respective indexes and then traverse and pick the first without <=0 element
        while(i<n){
